<h1 align="center">Car Rentals UI</h1>

<div align=center>
  <img src="./Readme%20Resources/Car Rentals Logo.png" alt="Logo" width="120" heigh="120"/>
</div>
...
<a href="https://github.com/mustafatoktas/W.BE_RepoVisitorCounterAPI" target="_blank"> <img src="https://toktasoft.com/api/github2/repo-visitor-counter.php?repo=wbfm83vgy6nq9cx&show_repo_name=1&show_date=1&show_brand=0" alt="Repo Visitor Counter"/> </a>
...
Bu uygulama, kullanıcıların araç kiralama hizmeti alabildikleri, daha önce kiralanmış araçların
memnuniyet ve öneri oranlarını görebildikleri ve fiyat bilgisi hakkında fikir sahibi oldukları 
araç kiralama uygulamasının arayüz çalışmasıdır.
...
- Uygulamanın proje dosyasını kendi bilgisayarınıza indirmek, kodları incelemek ve
  ...
  `git clone https://github.com/mustafatoktas/A.UI_CarRentals.git`
  komutunu çalıştırabilirsiniz.

- [Releases](https://github.com/mustafatoktas/A.UI_CarRentals/releases) sayfasına gidip
